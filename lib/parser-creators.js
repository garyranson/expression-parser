System.register(["./expressions"], function (exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var expressions_1, Constants, Creators, BinaryExpressionFactory, LogicalExpressionFactory, BinaryFactories;
    return {
        setters: [
            function (expressions_1_1) {
                expressions_1 = expressions_1_1;
            }
        ],
        execute: function () {
            ...
            BinaryExpressionFactory = (function () {
            ...
            LogicalExpressionFactory = (function () {
